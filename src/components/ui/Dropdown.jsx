        ...
        <AnimatePresence>
          {isOpen && (
              <motion.div
                ...
                className="absolute z-[100] top-full mt-2 w-full min-w-[170px] bg-background/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden"
              >
                {options.map((opt) => (
                  <button
                    key={opt.value}
